...
describe('convertDrupalProjectsToGristProjects', () => {
  ...
  it('should parse a json of drupal project and extract an array of drupal projects', ()=> {
    const drupalProjects: DrupalProjectType[] = convertJSONToDrupalProjects(drupalProjectsJson)
  ...
  "data": [
    ...
    },
    {
      ...
      "attributes": {
        ...
        "revision_log": null,
        "status": true,
        "title": "Coeur de Flandre : un territoire d'industrie qui mise sur la qualification et l'innovation",
        ...
        "metatag": null,
        "path": {
          "alias": "/coeur-de-flandre-un-territoire-dindustrie-qui-mise-sur-la-qualification-et-linnovation-64",
          "pid": 324,
          "langcode": "fr"
        },
        "field_agenda_txtfs": null,
        "field_department_city_txtps": "Pas-de-Calais (62) ",
        "field_description_txtps": "Saint-Omer est une commune française, sous-préfecture du département du Pas-de-Calais en région Hauts-de-France. Avec une population de 14 782 habitants en 2017, elle est la 11ᵉ ville du Pas-de-Calais. Elle est également la ville la plus peuplée de son aire urbaine qui compte en 2015, 91 256 habitants",
        "field_display_update_date": false,
        "field_funding_txtpl": null,
        "field_geocoding": {
        ...
        "field_teaser_txtps": "Situé sur deux départements, le territoire d’industrie Cœur de Flandre - Pays de Saint-Omer jouit d’une forte dynamique, soutenue par l’implication des services de l’État, de la Région, des intercommunalités et des industriels."
      },
      "relationships": {
        "node_type": {
          "data": {
    ...
    },
    {
      ...
      "attributes": {
        ...
        "field_teaser_txtps": "Après 200 ans d’exploitation minière qui ont fait de la France une grande puissance industrielle, le bassin minier entre dans une longue période de récession au début des années 1960."
      },
      "relationships": {
        "node_type": {
          "data": {
