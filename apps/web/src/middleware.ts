...
const contentSecurityPolicy = `
  default-src 'self' https://matomo.incubateur.anct.gouv.fr https://s2.adform.net https://sentry.incubateur.net;
  script-src 'self' https://matomo.incubateur.anct.gouv.fr https://s2.adform.net 'unsafe-inline' 'unsafe-eval';
  ...
  https://matomo.incubateur.anct.gouv.fr https://s2.adform.net https://sentry.incubateur.net 
  https://openmaptiles.geo.data.gouv.fr https://openmaptiles.github.io https://aides-territoires.beta.gouv.fr;
  worker-src 'self' blob:;
  font-src 'self' https: data:;
  frame-ancestors 'self' https://matomo.incubateur.anct.gouv.fr https://s2.adform.net;
  form-action 'self';
  base-uri 'self';
