...
const GoogleTagManager = () => {
  ...
  return (
    <>
      ...
      <img src={"https://ad.doubleclick.net/ddm/activity/src=3689183;type=solelus;cat=2023-0;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;npa=;gdpr=${GDPR};gdpr_consent=${GDPR_CONSENT_755};ord=1;num=" + getNum()} width="1" height="1" alt=""/>
    </>
  );
}
