...
export const ProjectRegionMapLink = () => (
    <div style={{ width: '100%' }}>
      <svg
        ...
        fontWeight={500}
      >
        <Link href="/projets?regions=Pays de la Loire">
          <g className="fr-pdl">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              cursor="pointer"
              fill="var(--blue-france-850-200)"
        ...
        <Link href="/projets?regions=Nouvelle-Aquitaine">
          <g className="fr-naq">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Centre-Val de Loire">
          <g className="fr-cvl">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Corse">
          <g className="fr-cor">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Bourgogne-Franche-Comté">
          <g className="fr-bfc">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Auvergne-Rhône-Alpes">
          <g className="fr-ara">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Occitanie">
          <g className="fr-occ">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Provence-Alpes-Côte d'Azur">
          <g className="fr-pac">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Bretagne">
          <g className="fr-bre region">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              cursor="pointer"
        ...
        <Link href="/projets?regions=Normandie">
          <g className="fr-nor">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Hauts-de-France">
          <g className="fr-hdf">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Île-de-France">
          <g className="fr-idf">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Grand Est">
          <g className="fr-ges">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=La Réunion">
          <g className="fr-re">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Guadeloupe">
          <g className="fr-gp">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Martinique">
          <g className="fr-mq">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Guyane Française">
          <g className="fr-gf">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <Link href="/projets?regions=Mayotte">
          <g className="fr-yt">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
